...
h5py= env.addPipModule('h5py', '2.8.0rc1', target='h5py*', default=False)
env.addPipModule('tflearn', '0.3', target='tflearn*', default=False, deps=[h5py])
env.addPipModule('keras', '2.1.5', target='keras*', default=False, deps=[h5py])
